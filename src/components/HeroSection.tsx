            ...
            >
              <motion.div variants={itemVariants}>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full md:w-auto justify-center md:justify-start">
                  ...
                  <Button size="lg" variant="outline" className="bg-white/10 backdrop-blur-md text-white border-white/20 hover:bg-green-400 hover:text-black w-full md:w-auto py-6" asChild>
